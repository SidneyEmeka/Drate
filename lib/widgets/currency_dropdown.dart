...
import 'package:drate/functions/funcs.dart';
...
class UsdToAny extends StatefulWidget {
  final rates;
  final Map allcurrencies;
  const UsdToAny({Key? key, @required this.rates, required this.allcurrencies})
      : super(key: key);
                  ...
                  children: [
                    ...
                    Expanded(
                      child: DropdownButton<String>(
                        ...
                        items: widget.allcurrencies.keys
                            .toSet()
                            .toList()
